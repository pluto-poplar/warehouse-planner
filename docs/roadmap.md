...
Addressing the Geometry Aware Mapping and Improved Path Planning TO-DOs. I've structured this as a tech roadmap and split it up into different phases of work.
...
* Grid values represent obstacle (1) and free space states (0). (Note this can also be probabalistic e.g. 0.75 means 75% likely to be an obstacle).
